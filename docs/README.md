...
本树上有编号文档 00-25、28-48（26 与 27 只存在于未并入的分支，见下）+ 若干附录。
...
| [48 Wave F 计划](48-wave-f-plan.md) | **当前这一波的权威计划**：还 Wave E 自己记下的两笔债——分工要有地方发生（工坊/摊位/环卫作业面，商贩是唯一让货在人之间流动的角色），以及十张脸要有各自的轮廓（去道具的必然代价：alpha 全部等于 Character-Base） |
