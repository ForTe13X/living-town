...
STYLES = {
    ...
    #  ② 第二版贴着头挂 ⇒ 与阿菲的齐肩短发只差 98px（当时的全场最小对）。往外撇两列之后是 208px。
    #     （2026-07-30 更正：这里原本写的 246 是抄的不是量的——重跑 --metrics，表里根本没有 246，
    #      Archer-Green ↔ Archer-Purple 实测 208。结论不变，98→208 仍是两倍多的改善。）
