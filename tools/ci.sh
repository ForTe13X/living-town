...
for scene in m2_test reqlife_test player_agency_test player_touch_test p1a_affiliate_test p1b_cargo_manifest_test p1c_east_ocean_carrier_test p1d_scale_export_test p1g_manifest_transaction_test s4_replay_test space_test save_load_test save_migration_test goals_test story_test event_prose_test; do
  SCENE_T0=$SECONDS
