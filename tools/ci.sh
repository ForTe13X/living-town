...
for scene in m2_test reqlife_test player_agency_test player_touch_test p1a_affiliate_test s4_replay_test space_test save_load_test goals_test story_test event_prose_test; do
  SCENE_T0=$SECONDS
